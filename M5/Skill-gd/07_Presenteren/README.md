...
Hier zie je een voorbeeld van hoe een Breadth-First Search algoritme werkt:
...
Uiteraard mis je nu nog wel de context. Wat is dat voor algoritme en waar is dat voor bedoeld.

_"Het Breadth-First Search (BFS) is een zoekalgoritme dat een boomstructuur met knooppunten stap voor stap doorzoekt._

_Stappen:_

_Start bij de wortel (of startknoop) en markeert deze als bezocht._
_Bezoek alle aangrenzende knopenpunten van de huidige knoop._
_Ga door naar het volgende niveau en herhaal het proces totdat het doel gevonden is of alle knopenpunten bezocht zijn."_

En vervolgens kun je met een code snippet ook laten zien hoe je dit hebt gebouwd.
...
Uiteindelijk kun je dit mooi proberen samen te voegen tot een **visual sheet**.

## Technical design en UML

Vaak zijn technische onderdelen lastig te presenteren. Denk bijvoorbeeld aan de structuur van je code of de verschillende stappen in een ingewikkeld algoritme. Om technische aspecten van je game toch goed te kunnen presenteren kun je in veel gevallen gebruik maken van UML.
...
Verwerk opdracht 10 A en B in een readme. Zet deze op github en lever een link in via Simulise.

### Opdracht 10 A Onderzoek een nieuw UML model
...
### Opdracht 10 B: Uitwerken UML model
