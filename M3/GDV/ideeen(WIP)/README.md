...
- Elke les leggen we een aantal **specifieke technieken** uit (bv. Rigidbody2D, Collisions, etc.)
- We laten **niet zien hoe je de complete game bouwt**, maar wel hoe je iedere techniek toepast
...
1. **Theorie** - Uitleg van de techniek
2. **Voorbeeld** - Hoe het in een echte game werkt
3. **Oefening** - Een kleine praktijk-opdracht om de technieken te trainen (niet aan de game gekoppeld)
...
Iedereen **start met Flappy Bird** (verplicht)

Als je nog tijd over hebt kies je daarna:

- **Asteroids** of **Joust** (optioneel en afhankelijk van voorkeur en vaardigheid)
...
- Minimaal 1 game hebben afgerond
- In overleg met de docenten kun je in plaats van "Angry Birds" ook gelijk kiezen voor "Asteroids" of "Joust".
