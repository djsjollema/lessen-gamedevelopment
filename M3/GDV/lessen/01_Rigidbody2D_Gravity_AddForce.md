...
3. **Scrijf een script**
   - Zorg dat je met 1 script alle 3 de ballen kunt laten springen met `AddForce`
   - Maak de `force` instelbaar via de inspector met `[SerializeField]`
   - Laat alle ballen met een andere kracht de lucht in springen
